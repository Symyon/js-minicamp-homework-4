...
function multiplyArguments() {
	...
	var prod = 0;
	if(arguments[0]) prod = arguments[0];
...
function addReverseString() {
	...
	String.prototype.reverse = function() {
		var reverstring = '';
		var originString = this.toString();
		for(var i = 1; i <= originString.length; i++) {
			reverstring += originString[originString.length-i];
		}
		return reverstring;
	};
}
